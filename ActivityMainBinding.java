...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      @NonNull EditText editTextNumberPassword, @NonNull EditText editTextTextEmailAddress2,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, button, editTextNumberPassword,
          editTextTextEmailAddress2, imageView, textView, textView2);
    }
